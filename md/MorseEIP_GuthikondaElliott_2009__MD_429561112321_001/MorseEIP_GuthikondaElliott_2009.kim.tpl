...
PARAM_FREE_cutoffs          double       length              [:]

PARAM_FREE_A1s              double       energy              [:]
PARAM_FREE_A2s              double       energy              [:]
PARAM_FREE_A3s              double       none                [:]

PARAM_FREE_B1s              double       none                [:]
PARAM_FREE_B2s              double       none                [:]
PARAM_FREE_B3s              double       none                [:]

PARAM_FREE_r1s              double       length              [:]
PARAM_FREE_r2s              double       length              [:]
PARAM_FREE_r3s              double       none                [:]

PARAM_FREE_temperature      double       none                []
